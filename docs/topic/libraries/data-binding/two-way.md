---
title: Two-way data binding  |  Views  |  Android Developers
...
# Two-way data binding Stay organized with collections Save and categorize content based on your preferences.
...
[`BaseObservable`](/reference/androidx/databinding/BaseObservable), and use a
[`@Bindable`](/reference/androidx/databinding/Bindable) annotation, as shown in
...
observable data objects](/topic/libraries/data-binding/observability).
...
two-way attributes](#two-way-attributes) and change listeners, which you can use
as part of your app. If you want to use two-way data binding with custom
attributes, you need to work with the
[`@InverseBindingAdapter`](/reference/androidx/databinding/InverseBindingAdapter)
and
[`@InverseBindingMethod`](/reference/androidx/databinding/InverseBindingMethod)
annotations.
...
1. Annotate the method that sets the initial value and updates when the value
   changes using `@BindingAdapter`:
...
[`@BindingAdapter`](/reference/androidx/databinding/BindingAdapter)) and what to
call when the view attribute changes (it calls the
[`InverseBindingListener`](/reference/androidx/databinding/InverseBindingListener)).
...
**Note:** Every two-way binding generates a *synthetic event attribute*. This
attribute has the same name as the base attribute, but it includes the suffix
`"AttrChanged"`. The synthetic event attribute allows the library to create a
method annotated using `@BindingAdapter` to associate the event listener to the
...
change,
[`TextViewBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/TextViewBindingAdapter.java#352).

## Converters

If the variable that's bound to a [`View`](/reference/android/view/View) object
...
the [`@InverseMethod`](/reference/androidx/databinding/InverseMethod) annotation
...
The platform provides built-in support for two-way data binding when you use
the attributes in the following table. For details on how the platform provides
this support, see the implementations for the corresponding binding adapters:

| Class | Attribute(s) | Binding adapter |
| --- | --- | --- |
| [`AdapterView`](/reference/android/widget/AdapterView) | `android:selectedItemPosition`  `android:selection` | [`AdapterViewBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/AdapterViewBindingAdapter.java) |
| [`CalendarView`](/reference/android/widget/CalendarView) | `android:date` | [`CalendarViewBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/CalendarViewBindingAdapter.java) |
| [`CompoundButton`](/reference/android/widget/CompoundButton) | [`android:checked`](/reference/android/R.attr#checked) | [`CompoundButtonBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/CompoundButtonBindingAdapter.java) |
| [`DatePicker`](/reference/android/widget/DatePicker) | `android:year`  `android:month`  `android:day` | [`DatePickerBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/DatePickerBindingAdapter.java) |
| [`NumberPicker`](/reference/android/widget/NumberPicker) | [`android:value`](/reference/android/R.attr#value) | [`NumberPickerBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/NumberPickerBindingAdapter.java) |
| [`RadioButton`](/reference/android/widget/RadioButton) | [`android:checkedButton`](/reference/android/R.attr#checkedButton) | [`RadioGroupBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/RadioGroupBindingAdapter.java) |
| [`RatingBar`](/reference/android/widget/RatingBar) | [`android:rating`](/reference/android/R.attr#rating) | [`RatingBarBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/RatingBarBindingAdapter.java) |
| [`SeekBar`](/reference/android/widget/SeekBar) | [`android:progress`](/reference/android/R.attr#progress) | [`SeekBarBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/SeekBarBindingAdapter.java) |
| [`TabHost`](/reference/android/widget/TabHost) | `android:currentTab` | [`TabHostBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/TabHostBindingAdapter.java) |
| [`TextView`](/reference/android/widget/TextView) | [`android:text`](/reference/android/R.attr#text) | [`TextViewBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/TextViewBindingAdapter.java) |
| [`TimePicker`](/reference/android/widget/TimePicker) | `android:hour`  `android:minute` | [`TimePickerBindingAdapter`](https://android.googlesource.com/platform/frameworks/data-binding/+/refs/heads/studio-master-dev/extensions/baseAdapters/src/main/java/androidx/databinding/adapters/TimePickerBindingAdapter.java) |
