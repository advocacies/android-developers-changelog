---
title: Memory leaks  |  App quality  |  Android Developers
...
# Memory leaks Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** These examples demonstrate commonly observed common memory leaks; they are
not intended to be indicative of modern recommended architecture patterns.
