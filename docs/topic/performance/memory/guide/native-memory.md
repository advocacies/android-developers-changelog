---
title: Analyzing native memory  |  App quality  |  Android Developers
...
# Analyzing native memory Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** To run `heapprofd`, you must build your app with
`<profileable android:shell="true"/>` or `<debuggable>`.

### Using the heap\_profile tool
...
com.android.memorylab](/static/topic/performance/memory/guide/images/native-memory/pprof-flamegraph.png)
...
**[← Bitmaps](/topic/performance/memory/guide/bitmaps) | [↑ Up](/topic/performance/memory/guide) | [WebView →](/topic/performance/memory/guide/webview-memory)**