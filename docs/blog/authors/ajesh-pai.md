---
title: Ajesh Pai  |  Android Developers' Blog
url: https://developer.android.com/blog/authors/ajesh-pai
source: html-scrape
---
...
[![LinkedIn](/static/blog/assets/linkedin.XPl_U-8i.svg)](https://www.linkedin.com/in/ajeshrpai/)
...
* 18
  ...
  ![](/static/blog/assets/performance_Week7_0b86aba329_2gDCJ1.webp)

  [Product News](/blog/categories/product-news)

  ## [Configure and troubleshoot R8 Keep Rules](/blog/posts/configure-and-troubleshoot-r8-keep-rules)

  [arrow\_forward](/blog/posts/configure-and-troubleshoot-r8-keep-rules)

  The Android build system's primary tool for achieving a small, fast, and secure application is the R8 optimizer, the compiler that handles dead code and resource removal for shrinking, code renaming or minification, and app optimization.
