---
title: What's new in Android for Cars: Unifying platforms and unlocking premium experiences  |  Android Developers' Blog
...
We're bringing more flexibility, new components, and new template capabilities to the Car App Library. [Car App Library 1.8.0-beta01](/jetpack/androidx/releases/car-app#version_18_2) and Car App Library [1.9.0-alpha01](/jetpack/androidx/releases/car-app#version_19_2) are now available.

## Build templated media apps for both Android Auto and Android Automotive OS

Developers can now build customized, distraction-optimized, media browsing and playback experiences for Android Automotive OS, making it easier to build once and deliver these [templated media apps](/training/cars/apps/media) to more users and more cars.

To help you test the experiences on Android Automotive OS, we'll be launching updated system images for the [Android Automotive OS emulator](/training/cars/testing/emulator#generic-images). Beginning with revision 3, the API level 35-ext15 system images will support apps built using the Car App Library media templates.

## Unlocking developer creativity with Car App Library 1.9.0 alpha

With the [1.9.0-alpha01](/jetpack/androidx/releases/car-app#version_19_2) release of the Car App Library, we're bringing features to help you build more differentiated, expressive experiences across Android Auto and cars with Google built-in.

![MediaHero1.gif](/static/blog/assets/Media_Hero1_a40e272f55_Z1YAerr.webp)
...
![NewComponents.png](/static/blog/assets/New_Components_9ada36cd00_1L6URm.webp)

We're introducing new [components](/design/ui/cars/guides/components/overview) and template capabilities to help developers build even more engaging experiences. For media apps, we're introducing an adaptive mini-player, so users can browse while still easily managing playback. Finally, we're adding more component types including [Chip](/reference/kotlin/androidx/car/app/model/Chip) and [CondensedItem](/reference/kotlin/androidx/car/app/model/CondensedItem) to increase the ways that content can be displayed and interacted with.

![HomePage.png](/static/blog/assets/Home_Page_4a3eacd161_i3u4M.webp)
...
* ## [Noam Gefen](/blog/authors/noam-gefen)
  ...
  [read\_more
  View profile](/blog/authors/noam-gefen)

  ![View Noam Gefen's profile](/static/blog/assets/PXL_20250405_073558833_2_6db88dff58_1qPfjF.webp)
...
* ## [Thomas Weathers](/blog/authors/thomas-weathers)
  ...
  [read\_more
  View profile](/blog/authors/thomas-weathers)

  ![View Thomas Weathers's profile](/static/blog/assets/DSC_0714_1_d2ffa1fb8f_ZtqlBA.webp)
