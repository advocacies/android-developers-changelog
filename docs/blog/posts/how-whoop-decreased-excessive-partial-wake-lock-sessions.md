---
title: How WHOOP decreased excessive partial wake lock sessions by over 90%  |  Android Developers' Blog
...
[![View Breana Tate's profile](/static/blog/assets/Breana_Tate_24c1d03bf2_Z1NRigS.webp)](/blog/authors/breana-tate)[![View Tracy Agyemang's profile](/static/blog/assets/Tracy_Agyemang_Headshot_9a0c523435_1hBimO.webp)](/blog/authors/tracy-agyemang)
...
![mayank.png](/static/blog/assets/mayank_0e8fbd512b_2vIyUQ.webp)
...
In addition to their internal metrics, the team also used **Android Studio’s**[**Background Task Inspector**](/studio/inspect/task) to inspect and debug the workers of interest, with a specific focus on associated wake locks, to align with the metric flagged in Android vitals.

### **Investigation: Distinguishing between worker variants**

WHOOP uses both [one-time](/develop/background-work/background-tasks/persistent/getting-started/define-work#schedule_one-time_work) and [periodic](/develop/background-work/background-tasks/persistent/getting-started/define-work#schedule_periodic_work) scheduling for some workers. This allows the app to reuse the same Worker logic for identical tasks with the same success criteria, differing only in timing.

Using their internal metrics made it possible to narrow their search to a specific worker, but they couldn't tell if the bug occurred when the worker was one-time, periodic, or both. So, they rolled out an update to use WorkManager’s [setTraceTag method](/reference/androidx/work/WorkRequest.Builder#setTraceTag(kotlin.String)) to distinguish between the one-time and periodic variants of the same Worker.
...
![manmeet.png](/static/blog/assets/manmeet_c1cb74a185_iTAdN.webp)
...
![partialWake.png](/static/blog/assets/partial_Wake_89e3b12fd0_Zlnd3b.webp)
...
* ## [Breana Tate](/blog/authors/breana-tate)
  ...
  ![View Breana Tate's profile](/static/blog/assets/Breana_Tate_24c1d03bf2_Z1NRigS.webp)
