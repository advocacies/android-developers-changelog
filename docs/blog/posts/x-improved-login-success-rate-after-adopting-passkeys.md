---
title: X improved login success rate by 2x after adopting passkeys  |  Android Developers' Blog
...
From breaking news and entertainment to sports and politics, [X](https://play.google.com/store/apps/details?id=com.twitter.android) is a social media app that aims to help nearly 500 million users worldwide get the full story with all the live commentary. Recently, X developers revamped the Android app’s login process so users never miss out on the conversations they’re interested in. Using the [Credential Manager API](/identity/sign-in/credential-manager), the team implemented new [passkey](/design/ui/mobile/guides/patterns/passkeys) authentication for quicker, easier, and safer access to the app.
...
![xSaurabh.png](/static/blog/assets/x_Saurabh_798337a48c_Z1Fin9T.webp)
...
![passkeys.png](/static/blog/assets/passkeys_560dd9df7b_sp0Ld.webp)
...
Learn how to improve your app’s login UX using [passkeys](/design/ui/mobile/guides/patterns/passkeys) and the [Credential Manager API](/identity/sign-in/credential-manager).
