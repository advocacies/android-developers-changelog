---
title: Datadog delivers millions of in-depth performance insights with ProfilingManager  |  Android Developers' Blog
...
![AANDDM_DataDog_Quote_01.png](/static/blog/assets/AANDDM_Data_Dog_Quote_01_06bf636466_Z25J28N.webp)
...
![AANDDM_DataDog_Quote_02.png](/static/blog/assets/AANDDM_Data_Dog_Quote_02_769d993429_O8qPO.webp)
...
* **Automated telemetry triggers:**By leveraging native system events to initiate trace recordings at key optimization points, Datadog reduces the need to build custom collection logic. While the initial rollout focuses on the [APP\_FULLY\_DRAWN](/reference/android/os/ProfilingTrigger?_gl=1*xix6h8*_up*MQ..*_ga*MTc4ODI2NDgwMy4xNzc5MzE2ODcw*_ga_6HH9YJMN9M*czE3NzkzMTY4NzAkbzEkZzAkdDE3NzkzMTY4NzAkajYwJGwwJGgyMTE1NzIyNjk1#TRIGGER_TYPE_APP_FULLY_DRAWN) signal, there are already plans to expand this observability to include [ANR](/reference/android/os/ProfilingTrigger?_gl=1*1hl4p7n*_up*MQ..*_ga*MTc4ODI2NDgwMy4xNzc5MzE2ODcw*_ga_6HH9YJMN9M*czE3NzkzMTY4NzAkbzEkZzAkdDE3NzkzMTY4NzAkajYwJGwwJGgyMTE1NzIyNjk1#TRIGGER_TYPE_ANR), [OOM](/reference/android/os/ProfilingTrigger?_gl=1*8x3pd*_up*MQ..*_ga*MTc4ODI2NDgwMy4xNzc5MzE2ODcw*_ga_6HH9YJMN9M*czE3NzkzMTY4NzAkbzEkZzAkdDE3NzkzMTY4NzAkajYwJGwwJGgyMTE1NzIyNjk1#TRIGGER_TYPE_OOM), and [COLD\_START](/reference/android/os/ProfilingTrigger?_gl=1*1ezx2ma*_up*MQ..*_ga*MTc4ODI2NDgwMy4xNzc5MzE2ODcw*_ga_6HH9YJMN9M*czE3NzkzMTY4NzAkbzEkZzAkdDE3NzkzMTY4NzAkajYwJGwwJGgyMTE1NzIyNjk1#TRIGGER_TYPE_COLD_START) triggers.
...
![datadog-profiling-blogpost-final.png](/static/blog/assets/datadog_profiling_blogpost_final_971624974a_jE6t9.webp)


An example of Datadog's time to initial display measurement with stack sampling powered by ProfilingManager
...
* ## [Arti Arutiunov](/blog/authors/arti-arutiunov)
  ...
  [read\_more
  View profile](/blog/authors/arti-arutiunov)
...
* ## [Nikita Ogorodnikov](/blog/authors/nikita-ogorodnikov)
  ...
  [read\_more
  View profile](/blog/authors/nikita-ogorodnikov)

  ![View Nikita Ogorodnikov's profile](/static/blog/assets/nickolay_profile_blog_4e456d6b31_Z1NuT0q.webp)
