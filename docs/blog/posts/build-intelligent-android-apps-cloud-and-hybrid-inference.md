---
title: Build intelligent Android apps: Cloud and hybrid inference  |  Android Developers' Blog
...
![features.png](/static/blog/assets/features_f241976ea5_ZkDp5d.webp)
...
![museum_assistant_upscaled.png](/static/blog/assets/museum_assistant_upscaled_86ffae3c30_Z20TuJD.webp)


Museum assistant is a chatbot that answers questions, such as ‘How can I get a ticket discount for Le Louvre?’
...
![grounding.png](/static/blog/assets/grounding_6a8e593136_22EPJv.webp)


Grounding data is added to the context window to enable the model to answer questions correctly and accurately.
...
![review_upscaled.png](/static/blog/assets/review_upscaled_c12b0e6b00_ecjNx.webp)
...
* **PREFER\_ON\_DEVICE:** Prioritizes local execution and falls back to cloud if Gemini Nano is unavailable.
* **PREFER\_IN\_CLOUD:** Prioritizes cloud execution and falls back to on-device if the device goes offline.
* **ONLY\_ON\_DEVICE:** Restricts execution strictly to the device.
* **ONLY\_IN\_CLOUD:** Restricts execution strictly to the cloud.
...
![translation_upscaled.png](/static/blog/assets/translation_upscaled_5e297d961e_2wJzig.webp)
...
* ## [Thomas Ezan](/blog/authors/thomas-ezan)
  ...
  ![View Thomas Ezan's profile](/static/blog/assets/thomas_ezan_d29c7508d0_l9O72.webp)
...
* ## [Jolanda Verhoef](/blog/authors/jolanda-verhoef)
  ...
  ![View Jolanda Verhoef's profile](/static/blog/assets/jolanda_b0e2beee3e_Z1KU2ms.webp)
...
* ## [Caren Chang](/blog/authors/caren-chang)
  ...
  ![View Caren Chang's profile](/static/blog/assets/Caren_Chang_e58d793559_1i40VV.webp)
