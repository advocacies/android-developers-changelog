---
title: Bring one-handed gestures to your Wear OS app  |  Android Developers' Blog
...
![](/static/blog/assets/Bring_one_handed_gestures_Strapi_defff06599_Z1FDx9g.webp)
...
[![View Chiara Chiappini's profile](/static/blog/assets/unnamed_14_383c39c2c2_Derb5.webp)](/blog/authors/chiara-chiappini)

[Chiara Chiappini](/blog/authors/chiara-chiappini)

Developer Relation Engineer, Android Developer Relations

One-handed gestures offer a convenient and touch-free way for users to interact with their watches, enabling them to perform key actions using only the hand on which the device is worn. First introduced on Pixel Watch with Wear OS 6.1, one-handed gestures made quick interactions effortless, such as starting and stopping a timer, accepting calls, and controlling media.
...
Starting with the 1.7 [beta release of Compose for Wear OS](/jetpack/androidx/releases/wear-compose), you can seamlessly integrate gesture control into your Wear Compose apps. To use this release, upgrade your Wear Compose dependency to:
...
Check out our new [design guidance](/design/ui/wear/guides/patterns/gestures) for integrating one-handed gestures into your Wear app.

### Integrating gestures with Compose on Wear OS

To provide seamless gesture support in Wear OS 7, we are introducing a new [Modifier.oneHandedGesture](/reference/kotlin/androidx/wear/compose/material3/onehandedgesture/oneHandedGesture.modifier) that you can apply to any existing interactive composable to make it gesture-aware.
...
* the [OneHandedGestureClickIndicator](/reference/kotlin/androidx/wear/compose/material3/onehandedgesture/OneHandedGestureClickIndicator.composable) for components like a  Button
* the [OneHandedGestureScrollIndicator](/reference/kotlin/androidx/wear/compose/material3/onehandedgesture/OneHandedGestureScrollIndicator.composable) component for scrolling
* the [OneHandedGestureHorizontalPageIndicator](/reference/kotlin/androidx/wear/compose/material3/onehandedgesture/OneHandedGestureHorizontalPageIndicator.composable) for the HorizontalPager
* the [OneHandedGestureVerticalPageIndicator](/reference/kotlin/androidx/wear/compose/material3/onehandedgesture/OneHandedGestureVerticalPageIndicator.composable) for the VerticalPager

The following example shows how to use the OneHandedGestureClickIndicator for a Button. See another example for using the [OneHandedGestureScrollIndicator](/reference/kotlin/androidx/wear/compose/material3/onehandedgesture/OneHandedGestureScrollIndicator.composable) in our [guidance](/training/wearables/compose/one-handed-gestures).
...
![sample-app.gif](/static/blog/assets/sample_app_38a9b816fe_Z8867z.webp)
...
![spotify.gif](/static/blog/assets/spotify_97253c677a_Z9cFov.webp)
...
Ensure your app is running on Wear OS 7, which provides the underlying platform support for gesture detection. Check out our new [one-handed gestures developer guide](/training/wearables/compose/one-handed-gestures)  to see how you can start building more convenient experiences for your users.

* [#Wear OS](/blog/topics/wear-os)
* [#made by google](/blog/topics/made-by-google)
* [#pixel watch](/blog/topics/pixel-watch)
...
* ## [Chiara Chiappini](/blog/authors/chiara-chiappini)
  ...
  [read\_more
  View profile](/blog/authors/chiara-chiappini)

  ![View Chiara Chiappini's profile](/static/blog/assets/unnamed_14_383c39c2c2_Derb5.webp)
