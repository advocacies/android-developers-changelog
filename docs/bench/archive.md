...
* [Leaderboard archive](https://developer.android.com/bench/archive)
...
![](https://developer.android.com/static/images/picto-icons/folder.svg)

## Leaderboard Archive

To view historical performance data for previous models, **select a version below**.

Select archive leaderboard
...
* #### May 18th 2026 Android LLM Benchmark
  ...
  **Latest results as of May 18th 2026:** This refresh includes [open-weight models](/bench/methodology#benchmarking-open-weight-models), adding new columns for [latency, tokens, and cost](/bench/methodology#new-leaderboard-dimensions).
* #### May 5th 2026 Android LLM Benchmark

  | Model | Score (%) info  Average percentage of 100 test cases successfully resolved across 10 runs for each model | arrow\_range Cl range (%) info  Expected performance range, reflecting the results' statistical reliability (p-value < 0.05) | Date |
  | --- | --- | --- | --- |
...
* #### March 5th 2026 Android LLM Benchmark
  ...
  | Model | Score (%) info  Average percentage of 100 test cases successfully resolved across 10 runs for each model | arrow\_range Cl range (%) info  Expected performance range, reflecting the results' statistical reliability (p-value < 0.05) | Date |
  | --- | --- | --- | --- |
  | Gemini 3.1 Pro Preview | **72.4** | 65.3 — 79.8 | 2026-02-27 |
  | Claude Opus 4.6 | **66.6** | 58.9 — 73.9 | 2026-02-26 |
  | GPT-5.2-Codex | **62.5** | 54.7 — 70.3 | 2026-02-26 |
  | Claude Opus 4.5 | **61.9** | 53.9 — 69.6 | 2026-02-26 |
  | Gemini 3 Pro Preview | **60.4** | 52.6 — 67.8 | 2026-02-27 |
  | Claude Sonnet 4.6 | **58.4** | 51.1 — 66.6 | 2026-02-27 |
  | Claude Sonnet 4.5 | **54.2** | 45.5 — 62.4 | 2026-02-26 |
  | Gemini 3 Flash Preview | **42.0** | 36.3 — 47.9 | 2026-02-26 |
  | Gemini 2.5 Flash | **16.1** | 10.9 — 21.9 | 2026-02-26 |
