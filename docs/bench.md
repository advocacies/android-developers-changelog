...
- New models • Jul 8th ![](https://developer.android.com/static/images/bench/icons/z-ai.png) **GLM 5.2**
- New models • Jul 8th ![](https://developer.android.com/static/images/bench/icons/kimi.png) **Kimi K2.7 Code**
- New models • Jul 8th ![](https://developer.android.com/static/images/bench/icons/minimax.png) **MiniMax M3**
- Archived models • Jul 8th ![](https://developer.android.com/static/images/bench/icons/anthropic.png) **Claude Opus 4.6, Claude Sonnet 4.5**
...
- Archived models • Jun 9th ![](https://developer.android.com/static/images/bench/icons/anthropic.png) **Claude Opus 4.6, Claude Opus 4.5**
...
See the full dataset on Harbor dashboard. [View more](https://hub.harborframework.com/datasets/android-bench/android-bench/latest)