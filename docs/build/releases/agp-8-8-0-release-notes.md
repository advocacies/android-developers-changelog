---
title: Android Gradle Plugin 8.8.0 (January 2025)  |  Android Developers
...
# Android Gradle Plugin 8.8.0 (January 2025) Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Gradle | 8.10.2 | 8.10.2 | To learn more, see [updating Gradle](/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
