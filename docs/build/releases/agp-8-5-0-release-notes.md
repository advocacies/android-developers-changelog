---
title: Android Gradle Plugin 8.5.0 (June 2024)  |  Android Developers
...
# Android Gradle Plugin 8.5.0 (June 2024) Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Gradle | 8.7 | 8.7 | To learn more, see [updating Gradle](/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
| SDK Build Tools | 34.0.0 | 34.0.0 | [Install](/studio/intro/update#sdk-manager) or [configure](/tools/releases/build-tools) SDK Build Tools. |
| NDK | N/A | 26.1.10909125 | [Install](/studio/projects/install-ndk#specific-version) or [configure](/studio/projects/install-ndk#apply-specific-version) a different version of the NDK. |
