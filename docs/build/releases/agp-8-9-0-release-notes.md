---
title: Android Gradle Plugin 8.9.0 (March 2025)  |  Android Developers
...
# Android Gradle Plugin 8.9.0 (March 2025) Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Gradle | 8.11.1 | 8.11.1 | To learn more, see [updating Gradle](/build/releases/gradle-plugin?buildsystem=ndk-build#updating-gradle). |
| SDK Build Tools | 35.0.0 | 35.0.0 | [Install](/studio/intro/update#sdk-manager) or [configure](/tools/releases/build-tools) SDK Build Tools. |
| NDK | N/A | 27.0.12077973 | [Install](/studio/projects/install-ndk#specific-version) or [configure](/studio/projects/install-ndk#apply-specific-version) a different version of the NDK. |
...
| Fixed Issues | |
| --- | --- |
| **Dexer (D8)** | |  | | --- | | [Issue #401489623](https://issuetracker.google.com/issues/401489623)  Backporting of android.os.Build.VERSION\_CODES\_FULL incorrect for Baklava | |
