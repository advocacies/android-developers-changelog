---
title: Google Play's billing system  |  Play Billing  |  Android Developers
...
# Google Play's billing system Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** Google Play's billing system is only for digital items. For physical goods and
services, or other non-digital content, see the
[Google Pay SDK](https://developers.google.com/pay/api/android/overview).
...
![Your Android app works with your developer backend and the Google
    Play backend (through Google Play Services).](/static/images/google/play/billing/overview-arch.svg)
...
![](/static/images/google/play/billing/dev-api.png)
...
* [**Google Play**](https://play.google.com). An online store where users can
  download apps and other digital products.
* [**Google Play Console**](https://play.google.com/console). A platform
...
* [**Google Cloud Console**](https://console.developers.google.com/). A
  platform that manages backend APIs, such as the Google Play Developer API.
* [**Google Play Billing Library**](/google/play/billing/integrate). An API that
...
* [**Google Play Developer API**](https://developers.google.com/android-publisher/).
  ...
  management tasks.
* [**Cloud Pub/Sub**](https://cloud.google.com/pubsub/). A fully managed
  ...
  Pub/Sub](https://cloud.google.com/pubsub/), you must have a project on the
  [Google Cloud Platform (GCP)](https://cloud.google.com/) with the Cloud
  Pub/Sub API enabled. If you aren't familiar with GCP and Cloud Pub/Sub, see the
  [Quickstart guide](https://cloud.google.com/pubsub/docs/quickstart-console).
* [**Real-time developer notifications**](/google/play/billing/getting-ready#configure-rtdn).
  A mechanism that lets you monitor state changes for Google Play-managed
  subscriptions in real time by leveraging [Cloud
