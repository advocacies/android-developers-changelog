...
[View on GitHub
open\_in\_new](https://github.com/android/skills/tree/main/play/play-billing-library-version-upgrade)

### Upgrade Play Billing Library

Use the Play Billing Library [Android skill](https://developer.android.com/tools/agents/android-skills) to automate your upgrade to the latest version.
...
* New APIs for [Billing Choice](/google/play/billing/billingchoice):
  + Added [`BillingClient.getBillingChoiceInfoAsync()`](/reference/com/android/billingclient/api/BillingClient#getBillingChoiceInfoAsync(com.android.billingclient.api.GetBillingChoiceInfoParams,com.android.billingclient.api.BillingChoiceInfoResponseListener)) to retrieve information about billing choices available to the user.
  + Added [`BillingChoiceInfo`](/reference/com/android/billingclient/api/BillingChoiceInfo) class which contains the response details, including image URLs and loyalty information.
  + Added [`GetBillingChoiceInfoParams`](/reference/com/android/billingclient/api/GetBillingChoiceInfoParams) to configure the request.
  + Added [`BillingChoiceInfoResponseListener`](/reference/com/android/billingclient/api/BillingChoiceInfoResponseListener) to receive the callback.
  + Added Kotlin extension [`BillingClient.getBillingChoiceInfo()`](/reference/kotlin/com/android/billingclient/api/package-summary#(com.android.billingclient.api.BillingClient).getBillingChoiceInfo(com.android.billingclient.api.GetBillingChoiceInfoParams)) suspend function.
  + Added [`BillingClient.showBillingProgramInformationDialog()`](/reference/com/android/billingclient/api/BillingClient#showBillingProgramInformationDialog(android.app.Activity,com.android.billingclient.api.BillingProgramInformationDialogParams,com.android.billingclient.api.BillingProgramInformationDialogListener)) to show an information dialog for a billing program.
  + Added [`BillingProgramInformationDialogParams`](/reference/com/android/billingclient/api/BillingProgramInformationDialogParams) to configure the dialog.
  + Added [`BillingProgramInformationDialogListener`](/reference/com/android/billingclient/api/BillingProgramInformationDialogListener) to receive the callback.
  + Added [`BillingProgramAvailabilityDetails.BillingChoiceAvailabilityDetails`](/reference/com/android/billingclient/api/BillingProgramAvailabilityDetails.BillingChoiceAvailabilityDetails) to provide details about billing choice availability.
  + Added [`ChoiceScreenType`](/reference/com/android/billingclient/api/BillingProgramAvailabilityDetails.BillingChoiceAvailabilityDetails.ChoiceScreenType) to specify the type of choice screen.
...
now available. See the [PBL 9 migration guide](/google/play/billing/migrate-pbl-latest) if you want to migrate from
...
* **Updated error codes for blocked Play Store activity**: Error codes for
  ...
  **Note:** For this feature to work, you need [AndroidX.core library](/jetpack/androidx/releases/core#core_and_core-ktx_version_190_2) version 1.9 or later.
* **Nullability update for developer-provided billing**: The
  [`DeveloperProvidedBillingDetails.getLinkUri()`](/reference/com/android/billingclient/api/DeveloperProvidedBillingDetails#getLinkUri()) method has
  ...
  [`DeveloperProvidedBillingDetails.getLinkUri()`](/reference/com/android/billingclient/api/DeveloperProvidedBillingDetails#getLinkUri()) method before parsing
  or launching browser intents.
* Updated `targetSdkVersion` to 35.
* You can now use [in-app messaging](/google/play/billing/subscriptions#in-app-messaging) to notify users
