---
title: Developer payload  |  Play Billing  |  Android Developers
...
# Developer payload Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** Purchases made using previous versions of the library using
[`setAccountId()`](/reference/com/android/billingclient/api/BillingFlowParams.Builder#setAccountId(java.lang.String))
(renamed to `setObfuscatedAccountId()`) are not returned
by `getAccountIdentifiers()`.
