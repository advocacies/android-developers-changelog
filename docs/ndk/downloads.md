---
title: NDK Downloads  |  Android NDK  |  Android Developers
...
* [Downloads](https://developer.android.com/ndk/downloads)

# NDK Downloads Stay organized with collections Save and categorize content based on your preferences.
...
| --- | --- | --- | --- |
| Windows 64-bit | android-ndk-r27d-windows.zip | 781506724 | 56607cbccd3642d4a1991f6bb3114a00f884f426 |
| Mac | android-ndk-r27d-darwin.dmg | 924374593 | 80f11292080fab4e869799f1d23caa88dcf3c709 |
| Linux 64-bit (x86) | android-ndk-r27d-linux.zip | 663956036 | 22105e410cf29afcf163760cc95522b9fb981121 |

For additional information about what's new and changed in this release, see
this [changelog](https://github.com/android/ndk/wiki/Changelog-r27).

## Latest Stable Version (r29)
...
| Mac | android-ndk-r29-darwin.dmg | 1156294030 | 0eecb29cfe791e039740e2a8bcf0af02b7132bd8 |
| Linux 64-bit (x86) | android-ndk-r29-linux.zip | 783549481 | 87e2bb7e9be5d6a1c6cdf5ec40dd4e0c6d07c30b |

## Latest Pre-Release Version (r30 beta 1)
...
| Platform | Package | Size (Bytes) | SHA1 Checksum |
| --- | --- | --- | --- |
| Windows 64-bit | android-ndk-r30-beta1-windows.zip | 714361038 | ec410335aac74d182b369a62c18079187b191149 |
| Mac | android-ndk-r30-beta1-darwin.dmg | 1041159992 | a6ba7993fac6b8a8940a5af687bee8357d869bf2 |
| Linux 64-bit (x86) | android-ndk-r30-beta1-linux.zip | 713550176 | 26b746e5a1e7ac3371f2a862a2f52a7c0740aa8a |

For additional information about what's new and changed in this release, see
this [changelog](https://github.com/android/ndk/wiki/Changelog-r30).
...
`https://dl.google.com/android/repository/android-ndk-<version>-darwin.zip`,
where `<version>` matches the version name in the DMG
artifact.

## Old Unsupported Versions

You can download older **unsupported** versions of the NDK from the
[Unsupported NDK Downloads](https://github.com/android/ndk/wiki/Unsupported-Downloads) page.
...
[Download the Android NDK LTS
for
Windows (64-bit)](https://dl.google.com/android/repository/android-ndk-r27d-windows.zip)

*android-ndk-r27d-windows.zip*
...
[Download the Android NDK LTS
for
Mac](https://dl.google.com/android/repository/android-ndk-r27d-darwin.dmg)

*android-ndk-r27d-darwin.dmg*
...
[Download the Android NDK LTS
for
Linux](https://dl.google.com/android/repository/android-ndk-r27d-linux.zip)

*android-ndk-r27d-linux.zip*

## Download the Android NDK Beta
...
[Download the Android NDK Beta
for
Windows (64-bit)](https://dl.google.com/android/repository/android-ndk-r30-beta1-windows.zip)

*android-ndk-r30-beta1-windows.zip*
...
[Download the Android NDK Beta
for
Mac](https://dl.google.com/android/repository/android-ndk-r30-beta1-darwin.dmg)

*android-ndk-r30-beta1-darwin.dmg*
...
[Download the Android NDK Beta
for
Linux](https://dl.google.com/android/repository/android-ndk-r30-beta1-linux.zip)

*android-ndk-r30-beta1-linux.zip*
...
[Download the Android NDK
for
Windows (64-bit)](https://dl.google.com/android/repository/android-ndk-r29-windows.zip)
...
[Download the Android NDK
for
Mac](https://dl.google.com/android/repository/android-ndk-r29-darwin.dmg)

*android-ndk-r29-darwin.dmg*
...
[Download the Android NDK
for
Linux](https://dl.google.com/android/repository/android-ndk-r29-linux.zip)
