---
title: Play Points overview  |  Other Play guides  |  Android Developers
url: https://developer.android.com/guide/playpoints
source: html-scrape
---
...
# Play Points overview Stay organized with collections Save and categorize content based on your preferences.
...
To offer your one-time products as Play Points promotions and ensure the
best user experience, you must complete the following tasks:

1. [Create](/guide/playpoints/create-products-one-time) one-time products and Play Points promotions.
2. [Detect](/guide/playpoints/deliver-items-one-time) and deliver one-time products.
3. [Test](/guide/playpoints/test-one-time) one-time products using promo codes.