---
title: Open files using the Storage Access Framework  |  App data and files  |  Android Developers
...
# Open files using the Storage Access Framework Stay organized with collections Save and categorize content based on your preferences.
...
* **Client app:** a custom app that invokes the
  ...
  intent actions and receives the files returned by document providers.
...
![](/static/images/providers/storage_datamodel.png)
...
* Each document can have different capabilities, as described by
  ...
  The same `COLUMN_DOCUMENT_ID` can be included in multiple directories.
...
![](/static/images/providers/storage_dataflow.png)
...
![Folder selection in system picker.](/static/images/providers/storage_picker.svg)
...
![](/static/images/providers/storage_photos.svg)
...
arrow\_forward](/guide/topics/providers/create-document-provider)