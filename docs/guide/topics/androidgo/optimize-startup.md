---
title: Improve startup latency  |  Build for Billions  |  Android Developers
...
# Improve startup latency Stay organized with collections Save and categorize content based on your preferences.
