---
title: <permission-tree>  |  App architecture  |  Android Developers
...
# <permission-tree> Stay organized with collections Save and categorize content based on your preferences.
...
:   Declares the base name for a tree of permissions. The application takes
    ...
    to the tree by calling `PackageManager.addPermission()`.
