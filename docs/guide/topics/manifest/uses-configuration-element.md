---
title: <uses-configuration>  |  App architecture  |  Android Developers
...
# <uses-configuration> Stay organized with collections Save and categorize content based on your preferences.
