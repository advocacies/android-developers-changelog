---
title: Engage SDK Read: Third-party technical integration instructions  |  Other Play guides  |  Android Developers
...
# Engage SDK Read: Third-party technical integration instructions Stay organized with collections Save and categorize content based on your preferences.
...
published to more devices and form factors. Please contact
...
* **Recommendation** clusters show personalized suggestions for content to read
  ...
  + **Recommendation Cluster:** A UI view that contains a group of
    ...
    ![](/static/images/guide/playcore/engage/read-term-1.png)
  ...
  + **Entity:** An object representing a single item in a cluster. An entity
    ...
    entity data](#provide-entity-data) section for a list of supported entity
    types.

    ![](/static/images/guide/playcore/engage/read-term-2.png)
...
* The **Continuation** cluster shows unfinished books from multiple developer
  ...
  ![](/static/images/guide/playcore/engage/read-term-3.png)
...
* The **Featured** cluster showcases a selection of items from multiple
  ...
  ![](/static/images/guide/playcore/engage/read-term-4.png)
...
| --- | --- | --- |
| Name | **Required** |  |
| Poster images | **Required** | At least one image must be provided. See [Image Specifications](#image-specs) for guidance. |
| Author | **Required** | At least one author name must be provided. |
| Action link uri | **Required** | The deep link to the provider app for the ebook.  Note: You can use deep links for attribution. [Refer to this FAQ](/guide/playcore/engage/faq#deeplinks-attribution) |
...
| Continue book type | Optional | TYPE\_CONTINUE - Resume on a unfinished book.  TYPE\_NEXT - Continue on a new one of a series.  TYPE\_NEW - Newly released. |
...
| Poster images | **Required** | At least one image must be provided. See [Image Specifications](#image-specs) for guidance. |
| Author | **Required** | At least one author name must be provided. |
| Action link uri | **Required** | The deep link to the provider app for the audiobook.  Note: You can use deep links for attribution. [Refer to this FAQ](/guide/playcore/engage/faq#deeplinks-attribution) |
...
| Action link uri | **Required** | The deep link to the provider app for the audiobook or ebook.  Note: You can use deep links for attribution. [Refer to this FAQ](/guide/playcore/engage/faq#deeplinks-attribution) |
...
[`engage-developers@google.com`](mailto:engage-developers@google.com) before using delete APIs.
...
The following [intents](/reference/android/content/Intent) will be sent by the
service:
...
* `com.google.android.engage.action.PUBLISH_FEATURED`
  ...
  intent.
* com.google.android.engage.action.PUBLISH\_CONTINUATION`It is recommended to start a`publishContinuationCluster` call when receiving
  this intent.
...
* Google will perform a verification and review internally to make sure the
  integration works as expected. If changes are needed, Google will contact you
  with any necessary details.
* When testing is complete and no changes are needed, Google will contact you to
...
* After Google has confirmed that your updated APK has been published to the
  ...
  clusters will be published and visible to users.