---
title: Android Studio Meerkat Feature Drop | 2024.3.2 (May 2025)  |  Android Developers
...
# Android Studio Meerkat Feature Drop | 2024.3.2 (May 2025) Stay organized with collections Save and categorize content based on your preferences.
...
contrast issues.
![Themed app icon preview](/static/studio/images/design/theme-app-icon-preview.gif)
...
* IDE-level prompts are private to yourself and can be used across multiple
  projects.
* Project-level prompts can be shared among teammates working on the same
  project. To share prompts across the team you must add the `.idea` folder to
...
![](/static/studio/images/prompt-library.png)
...
1. **Modern and declarative**:Compose's declarative syntax makes animation
   code more readable and maintainable.
2. **Integrated animation tools**: Compose Animation Preview offers a
   streamlined workflow for creating and testing animations directly within
   your Compose code.
3. **Future-proof development**: By focusing on Compose, we're investing in
