...
app by using the
[Navigation Architecture Component](/topic/libraries/architecture/navigation).

![](/static/studio/images/releases/navigation-editor_2x.png)

For more information, see
[Implement navigation with the Navigation Architecture Component](/topic/libraries/architecture/navigation/navigation-implementing).
...
![](/static/studio/images/releases/delete-unused-directories-dialog-2x.png)
...
![](/static/studio/images/projects/new-project-wizard-choose_2x.png)

For more information, see [Create a project](/studio/projects/create-project).
...
[Memory Profiler](/studio/profile/memory-profiler) now samples memory
...
![](/static/studio/images/releases/profiler-memory-allocation-modes.png)
...
In the [CPU Profiler](/studio/profile/cpu-profiler), you can now inspect how
...
To see frame rendering data, [record a trace](/studio/profile/cpu-profiler#method_traces)
...
![](/static/studio/images/releases/frame-rendering_2x.png)
...
![](/static/studio/images/releases/fragments-activity-bar_2x.png)
...
![](/static/studio/images/releases/network-profiler-text_2x.png)

For more information, see
[Inspect network traffic with Network Profiler](/studio/profile/network-profiler).
...
For more information, see
[Auto-download missing packages with Gradle](/studio/intro/update#download-with-gradle).
...
[update your NDK](/ndk/guides#download-ndk) to r18 or higher.
...
[Manually configure Gradle](/studio/projects/gradle-external-native-builds#configure-gradle).
...
[build dependencies](/studio/build/dependencies)
...
Android Studio now lets you build [Android App Bundles](/guide/app-bundle) with
full support for [Google Play Instant](/topic/google-play-instant/overview). In
...
You can then
[create an instant-enabled feature](/studio/projects/dynamic-delivery#create_instant_enabled)
...
[edit your run configuration](/studio/run/rundebugconfig#editing) and check the
box next to **General > Deploy as instant app**.

## Single-variant project sync

[Syncing your project](/studio/build#sync-files) with your build configuration
...
For more information, see
[Enable single-variant project sync](/studio/build/optimize-your-build#single_variant_sync).
...
![](/static/studio/images/releases/user-sentiment-positive.png)
![](/static/studio/images/releases/user-sentiment-negative.png)
