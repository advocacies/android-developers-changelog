---
title: Add a module for a new device  |  Android Studio  |  Android Developers
url: https://developer.android.com/studio/projects/add-app-module
source: html-scrape
---
...
2. In the **Create New Module** window that appears, Android Studio offers
   ...
   * Wear OS Module
   * Android TV Module
   * Glass ModuleSelect the module for the device you want, and then click **Next**.
3. In the **Configure your new module** form, enter the following details:
   ...
   * **Package Name**: This is the Java namespace for the code
     ...
     [`package`](/guide/topics/manifest/manifest-element#package)
     attribute in the module's
     [Android manifest file](/guide/topics/manifest/manifest-intro).
   ...
   * **Minimum SDK**:
   ...
   Then click **Next**.
4. Depending on which device module you selected, the following page displays a selection of
...
5. If you chose an activity template, enter the settings for your activity on the **Customize
   ...
   Name**, **Title**, and **Source Language**, but each template has activity-specific settings. Click
...
2. In the **Source directory** box, type or select the directory of the module(s)
   that you want to import:
   * If you are importing one module, indicate its root directory.* If you are importing multiple modules from a project, indicate the
       ...
       **Import** box is checked for each module that you want to import.If your module(s) have other dependencies, they will be listed to import under
...
* To learn about build settings for a module, see
  [The Module-level Build File](/studio/build#module-level).
* To build and run a specific module, see
  [Select and build a different module](/studio/run#build-module).
...
* For Android TV modules:
  [Get Started with TV Apps](https://developer.android.com/training/tv/start/start.html)
* For Glass modules:
  [GDK Quick Start](https://developers.google.com/glass/develop/gdk/quick-start#for_android_experts)
