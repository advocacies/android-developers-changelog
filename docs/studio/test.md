...
tests, see [Test apps on Android](/training/testing) and [Test your Compose layout](/develop/ui/compose/testing).
...
* **Advanced testing**
  ...
  [UI Automator](/training/testing/other-components/ui-automator), or use
  [Monkey](/studio/test/other-testing-tools/monkey) for stress testing.