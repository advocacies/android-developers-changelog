---
title: Android Studio Quail 4  |  Android Developers
...
# Android Studio Quail 4 Stay organized with collections Save and categorize content based on your preferences.
...
stable channel, Android Studio Quail 4. You can update to it inside Android
Studio by clicking **Help** > **Check for updates**
(**Android Studio** > **Check for updates** on macOS), or by downloading
directly:

## Download Android Studio Quail 4 | 2026.1.4 Patch 1
...
[Download Android Studio Quail 4 | 2026.1.4 Patch 1
for
Linux](https://edgedl.me.gvt1.com/android/studio/ide-zips/2026.1.4.8/android-studio-quail4-patch1-linux.tar.gz)
...
[Download Android Studio Quail 4 | 2026.1.4 Patch 1
for
ChromeOS](https://edgedl.me.gvt1.com/android/studio/install/2026.1.4.8/android-studio-quail4-patch1-cros.deb)

*android-studio-quail4-patch1-cros.deb*
...
[Download Android Studio Quail 4 | 2026.1.4 Patch 1
for
Mac](https://edgedl.me.gvt1.com/android/studio/install/2026.1.4.8/android-studio-quail4-patch1-mac.dmg)

*android-studio-quail4-patch1-mac.dmg*
...
[Download Android Studio Quail 4 | 2026.1.4 Patch 1
for
Mac (ARM)](https://edgedl.me.gvt1.com/android/studio/install/2026.1.4.8/android-studio-quail4-patch1-mac_arm.dmg)

*android-studio-quail4-patch1-mac\_arm.dmg*
...
Mac with Apple chip
[Mac with Apple chip](https://edgedl.me.gvt1.com/android/studio/install/2026.1.4.8/android-studio-quail4-patch1-mac_arm.dmg)

*android-studio-quail4-patch1-mac\_arm.dmg*

Mac with Intel chip
[Mac with Intel chip](https://edgedl.me.gvt1.com/android/studio/install/2026.1.4.8/android-studio-quail4-patch1-mac.dmg)
...
[Download Android Studio Quail 4 | 2026.1.4 Patch 1
for
Windows](https://edgedl.me.gvt1.com/android/studio/ide-zips/2026.1.4.8/android-studio-quail4-patch1-windows.zip)

*android-studio-quail4-patch1-windows.zip*
...
[Download Android Studio Quail 4 | 2026.1.4 Patch 1
for
Windows](https://edgedl.me.gvt1.com/android/studio/install/2026.1.4.8/android-studio-quail4-patch1-windows.exe)

*android-studio-quail4-patch1-windows.exe*
...
[closed issues](/studio/releases/fixed-bugs/studio/2026.1.4).

To view the release notes for older versions of Android Studio, see
[Past releases](/studio/past-releases/past-android-studio-releases).

For early access to upcoming features and improvements, see the [Preview builds
of Android Studio](/studio/preview).

If you encounter problems in Android Studio, check the
[Known issues](/studio/known-issues) or [Troubleshoot](/studio/troubleshoot)
page.
...
There is now a time-based compatibility policy for AGP and Android Studio.
Each Android Studio version will support AGP versions released within the
previous 3 years. AGP versions older than 3 years will no longer be supported
in newer Android Studio versions. If your project's AGP version is
incompatible, Android Studio will require you to update AGP.

If your project is not supported by a specific version of Android Studio, you
can still open and update your project using an
[older version of Android Studio](/studio/archive).
...
Android Studio version | Required AGP version || Ladybug Feature Drop | 2024.2.2 | 3.2-8.8 |
...
[Android Gradle plugin release notes](/studio/releases/gradle-plugin).
...
OS. You can
[install preview versions of Android Studio alongside a stable version](/studio/preview/install-preview#install_alongside_your_stable_version).

The minimum versions of Android Studio and AGP are as follows:

API level | Minimum Android Studio version | Minimum AGP version || 37.0 | Panda 3 | 2025.3.3 Patch 1 | 9.1.1 |
...
Currently, support for Android Studio Otter 2 Feature Drop has been
deprecated and will be disabled entirely at the next major release. All newer
