---
title: Integrate with the Gemini Live API for audio glasses and display glasses  |  Android XR for Jetpack XR SDK  |  Android Developers
...
# Integrate with the Gemini Live API for audio glasses and display glasses Stay organized with collections Save and categorize content based on your preferences.
