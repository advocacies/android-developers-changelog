...
dedicated classes like [Box](/reference/kotlin/androidx/ink/geometry/Box) and [Vec](/reference/kotlin/androidx/ink/geometry/Vec)), as well as arbitrary shapes (using
