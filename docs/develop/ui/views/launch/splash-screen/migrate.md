---
title: Migrate your splash screen implementation to Android 12 and later  |  Views  |  Android Developers
...
# Migrate your splash screen implementation to Android 12 and later Stay organized with collections Save and categorize content based on your preferences.
...
app to the [`SplashScreen`](/reference/android/window/SplashScreen) API to help
...
screen](/about/versions/12/features/splash-screen) on
[cold](/topic/performance/vitals/launch-time#cold) and [warm
starts](/topic/performance/vitals/launch-time#warm) for all apps. By default,
this system splash screen is constructed using your app's launcher icon element
and the [`windowBackground`](/reference/android/R.attr#windowBackground) of your
...
* If your existing splash screen is implemented using a
  [custom theme that overrides `android:windowBackground`](/develop/ui/views/launch/splash-screen#set-theme),
...
* If your existing splash screen is implemented using a dedicated `Activity`,
  ...
  [the system splash screen](/about/versions/12/features/splash-screen)
...
[Androidx `SplashScreen` compat library](/reference/kotlin/androidx/core/splashscreen/SplashScreen)
...
practices](#best-practices) described on this document for adapting your
...
1. In the `build.gradle` file,
   [change your `compileSdkVersion`](/about/versions/12/setup-sdk) and include
...
[Keep the splash screen on-screen for longer periods](/about/versions/12/features/splash-screen#suspend-drawing)
and
[Customize the animation for dismissing the splash screen](/about/versions/12/features/splash-screen#customize-animation).
...
[`SplashScreen.setKeepOnScreenCondition`](/reference/kotlin/androidx/core/splashscreen/SplashScreen#setkeeponscreencondition)
...
screen](/about/versions/12/features/splash-screen#customize-animation).
However, it's best to avoid this scenario if possible and use the `SplashScreen`
API to brand your splash screen.

If you need to display a [dialog](/develop/ui/views/components/dialogs), we
...
* **Use lazy loading for your components, modules, or libraries.** Avoid loading
  ...
  [App Startup library](/topic/libraries/app-startup) to initialize components
...
[
](/static/images/guide/topics/ui/splash-screen/cached-ui-indicators.mp4)
