...
![Since Compose 1.9.0, Compose and Views have the same jank rate](/static/develop/ui/compose/performance/images/jank.svg)


Since Compose 1.9.0, Compose and Views have the same jank rate.

For additional metrics and to learn about our methodologies, see [Hero
benchmarks](/develop/ui/compose/performance/herobenchmark).
