...
has not been initialized at this point. If you need to trigger the launch
...
See [Navigating with Compose](/guide/navigation#framework-options) and
...
[navigation routes](/guide/navigation/design/nested-graphs#compose) or [the
navigation graph](/guide/navigation/use-graph/programmatic#share-ui-related-data-between-destinations-with-viewmodel)
