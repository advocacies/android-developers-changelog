---
title: Theming with Styles  |  Jetpack Compose  |  Android Developers
url: https://developer.android.com/develop/ui/compose/styles/theming
source: html-scrape
---
...
# Theming with Styles Stay organized with collections Save and categorize content based on your preferences.
...
[file Styles issues](https://issuetracker.google.com/issues/new?component=612128).
...
![Diagram showing Theming with Styles with the new layer introduction](/static/develop/ui/compose/styles/images/theming_styles_layer.png)
...
have created your [own custom theme already](/develop/ui/compose/designsystems/custom#implementing-fully-custom). You build a `CompanyTheme` that
...
If you are building out your own [custom theme](/develop/ui/compose/designsystems/custom) without using Material, and
...
Styles vs modifiers](/develop/ui/compose/styles/styles-vs-modifiers)

[Next

Performance of Styles

arrow\_forward](/develop/ui/compose/styles/performance)