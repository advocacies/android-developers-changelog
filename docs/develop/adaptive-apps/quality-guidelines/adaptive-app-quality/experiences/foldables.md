---
title: Foldables  |  Adaptive Apps  |  Android Developers
url: https://developer.android.com/develop/adaptive-apps/quality-guidelines/adaptive-app-quality/experiences/foldables
source: html-scrape
---
...
* [Quality guidelines](https://developer.android.com/develop/adaptive-apps/quality-guidelines/adaptive-app-quality)
...
| --- | --- | --- |
| Foldables\_Postures | [T-Foldables\_Postures](#T-Foldables_Postures) | App supports all foldable postures and related use cases:   * Tabletop posture — Video calling and video or audio playback. * Book posture — Reading lengthy text content.  See [Learn about foldables](/develop/ui/compose/layouts/adaptive/foldables/learn-about-foldables). |
...
| T-Foldables\_Multi-Instance | [T-Foldables\_Multi-Instance](#T-Foldables_Multi-Instance) | With the device folded and unfolded, launch multiple instances of the app in separate windows in portrait and landscape orientations and in multi‑window mode. |