---
title: Build adaptive navigation  |  Adaptive Apps  |  Android Developers
url: https://developer.android.com/develop/adaptive-apps/guides/build-adaptive-navigation
source: html-scrape
---
...
based on [window size classes](/develop/ui/compose/layouts/adaptive/window-size-classes). However, you may want to override this
