---
title: Observe intermediate worker progress  |  Background work  |  Android Developers
...
# Observe intermediate worker progress Stay organized with collections Save and categorize content based on your preferences.
...
[`WorkInfo.getStopReason()`](/reference/androidx/work/WorkInfo#getStopReason()):
...
[Work states](/develop/background-work/background-tasks/persistent/how-to/states).