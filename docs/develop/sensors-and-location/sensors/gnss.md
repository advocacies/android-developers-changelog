...
# Raw GNSS Measurements Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** Google launched version 3.1 of the
[GnssLogger](https://play.google.com/store/apps/details?id=com.google.android.apps.location.gps.gnsslogger)
in the Play Store with several new features.**Note:** Google has released version 4.6.0.1 of the GNSS Analysis App. For more
information, see the [GNSS Analysis app v4.6.0.1 release notes](#release).
...
[`GnssAntennaInfo`](/reference/android/location/GnssAntennaInfo) class to access
...
* The characteristics supplied by this API are only specific to the device
  model, not an individual device.
...
[Copy files to/from a device](/studio/command-line/adb#copyfiles).
...
![GNSS Logger and GNSS Analysis](/static/images/sensors/gnss_figure_1.png)
...
![GNSS Analysis Control Panel](/static/images/sensors/gnss_figure_2.png))
...
![GNSS Analysis interactive plots](/static/images/sensors/gnss_figure_3.png))
...
![GNSS Analysis test report](/static/images/sensors/gnss_figure_4.png)
...
![C/No data comparison side-by-side](/static/images/sensors/gnss_figure_5.png)
