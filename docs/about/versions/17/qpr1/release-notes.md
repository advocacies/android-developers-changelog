...
* *An issue where the mouse pointer becomes invisible on external displays when Work profile or FLAG\_SECURE applications are active. ([**Issue #446715557**](https://issuetracker.google.com/issues/446715557))*
