---
title: Android 7.1 for Developers  |  Android Developers
...
# Android 7.1 for Developers Stay organized with collections Save and categorize content based on your preferences.
...
![Image keyboard support on Nexus 6P](/static/images/guide/topics/text/image-keyboard-sample.png)

*Image keyboard support:* Lets users
input images and other content directly from a keyboard.

![App shortcuts on Nexus 6P](/static/images/guide/topics/ui/shortcuts.png)
...
new emoji characters by calling `Paint.hasGlyph()`.

![Collection of new professional female emoji in a variety of skin tones](/static/images/about/versions/nougat/new-emoji-7.1.png)
...
![Screen displaying the Image Asset tool](/static/images/about/versions/nougat/round-icon.png)
