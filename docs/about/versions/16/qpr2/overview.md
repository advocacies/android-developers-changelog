...
url: https://developer.android.com/about/versions/16/qpr2/overview
source: html-scrape
---
...
* **Feedback and support** - Your feedback is critical!
  [Report issues](/about/versions/16/qpr2/feedback) and let us know what you think! Connect with other
  developers in the [Developer Community][community] to share your
  experiences.
...
later. Please [give us your feedback](/about/versions/16/qpr2/feedback) during this time, to let us know
...
* Visit the [Feedback and issues](/about/versions/16/qpr2/feedback) page for complete information on
...
* [Android Preview issue tracker](/about/versions/16/qpr2/feedback#issue_tracker) is our **primary issue
...
* The [Android Developer Community][community] is a community where you can
  **connect with other users and developers** who are working with the Android
  16 preview builds. You can share observations and ideas and find answers to
  questions there.
