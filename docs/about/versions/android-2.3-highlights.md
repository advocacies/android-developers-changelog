---
title: Gingerbread  |  Android Developers
...
# Gingerbread Stay organized with collections Save and categorize content based on your preferences.
...
![](/static/sdk/images/2.3/home-menu.png)
![](/static/sdk/images/2.3/home-plain.png)
...
the key and sliding to select a character.

![](/static/sdk/images/2.3/onetouch.png)

![](/static/sdk/images/2.3/selection.png)
...
![](/static/sdk/images/2.3/running.png)

![](/static/sdk/images/2.3/power.png)
...
![](/static/sdk/images/2.3/sipcall.png)  
![](/static/sdk/images/2.3/ffc.png)
...
the browser, email, or another application. Downloads is built on a completely new
...
* [Enhancements for gaming](#gaming)
* [New forms of communication](#communication)
* [Rich multimedia](#multimedia)
...
* Concurrent garbage collector — The Dalvik VM introduces a new,
...
The platform provides a software implementation of [Khronos OpenSL ES](http://www.khronos.org/opensles/), a standard API
...
The platform provides an interface to its [Khronos EGL](http://www.khronos.org/egl/) library, which lets
...
NDK, please see the [Android NDK](https://developer.android.com/sdk/ndk/index.html)
page.
...
* Integrated support for the VP8 open video compression format and the WebM
...
* SIP stack, configurable by device manufacturer* Support for Near Field Communications (NFC), configurable by device manufacturer
  * Updated BlueZ stack
...
* Core libraries:
  + Expanded I18N support (full worldwide encodings, more locales)+ Faster Formatter and number formatting. For example, float formatting is 2.5x faster.
...
For more information about the new developer APIs, see the [Android 2.3 version notes](/about/versions/android-2.3) and the [API Differences Report](/sdk/api_diff/9/changes).