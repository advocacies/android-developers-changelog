---
title: Get Android 13  |  Android Developers
...
# Get Android 13 Stay organized with collections Save and categorize content based on your preferences.
...
4. In Android Studio, click **Tools > Device Manager**, then click **Create
   ...
   ![](/static/images/about/versions/13/13-create-avd.png)
...
8. After returning to the list of virtual devices in the Device Manager, find
   ...
   ![](/static/images/about/versions/13/13-launch-avd-icon.png) to
   start it.
...
![](/static/images/about/versions/13/13-resizable-emulator.png)
](/images/about/versions/13/13-resizable-emulator.png)](/static/images/about/versions/13/13-resizable-emulator.mp4)


Use the new resizable device definition for the Android Emulator
to test Android 13 in a variety of large screen scenarios.
