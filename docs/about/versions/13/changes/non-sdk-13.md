---
title: Updates to non-SDK interface restrictions in Android 13  |  Android Developers
...
# Updates to non-SDK interface restrictions in Android 13 Stay organized with collections Save and categorize content based on your preferences.
...
* Non-SDK interfaces that were unsupported in Android 12 (API level 31) that
  are [blocked in Android 13](#new-blocked).
