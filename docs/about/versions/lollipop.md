...
# Android Lollipop Stay organized with collections Save and categorize content based on your preferences.





![Assorted display of devices including a watch, mobile, and landscape-oriented tablet showcasing Android 5.0](/static/images/home/l-hero_2x.png)
...
[Android
5.0 API Overview](/about/versions/android-5.0). Or, read more
about Android 5.0 for consumers at
[www.android.com](https://www.android.com/versions/lollipop-5-0/).

**Note:** The Android 5.1 Lollipop MR1 update is available with additional features
and fixes. For more information, see the
[Android 5.1 API Overview](/about/versions/android-5.1).
...
](/static/design/material/videos/ContactsAnim.mp4)
...
Continuing the focus on smoother performance, Android 5.0 offers improved A/V sync. The audio and graphics pipelines have been instrumented for more accurate timestamps, enabling
video apps and games to display smooth synchronized content.

## Notifications

![Top section of mobile showing heads-up notification alert](/static/images/versions/notification-headsup.png)
...
![Mobile showing the new redesigned Overview space - formerly called Recents](/static/images/versions/recents_screen_2x.png)
...
![Tablet showing Gameloft's Rival Knights gameplay](/static/images/versions/rivalknights.png)
...
In addition to giving greater control over image capture, the new APIs also
expose detailed information about the camera's properties and capabilities and
provide metadata that describes the capture settings of each frame.
...
![Mobile displaying unified view of user's personal and work apps, which are badged for easy identification](/static/images/android-5.0/managed_apps_launcher@2x.png)
...
[managed provisioning process](/about/versions/android-5.0#Enterprise)
...
For company-owned devices, IT administrators can start with a new device and configure it with a
[device owner](/about/versions/android-5.0#DeviceOwner). Employers can
issue these devices with a device owner app already installed that
can configure global device settings.
...
![Chromium WebView logo](/static/images/kk-chromium-icon.png)
...
![](/static/images/versions/battery_historian.png)
