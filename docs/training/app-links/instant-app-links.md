---
title: Create App Links for Instant Apps  |  App architecture  |  Android Developers
...
# Create App Links for Instant Apps Stay organized with collections Save and categorize content based on your preferences.
...
* You must set `autoVerify="true"` in at least one intent filter in both the
  instant and the installable app. (See how to [enable automatic verification](/training/app-links/verify-android-applinks#config-verify).)
* You must publish one `assetlinks.json` for each domain (and subdomain
  ...
  [support app linking for multiple hosts](/training/app-links/verify-android-applinks#multi-host)).
...
* Use of wildcards in your intent filter's host attribute is not recommended.
  (See how to [support app linking from multiple subdomains](/training/app-links/verify-android-applinks#multi-subdomain).)
