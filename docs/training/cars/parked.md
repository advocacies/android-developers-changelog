...
In particular, see [Support different display sizes](/develop/ui/compose/layouts/adaptive/support-different-display-sizes) for details on making
...
built-in, or both platforms. See [Distribute to cars](/training/cars/distribute) for more
...
filtering built into the Google Play Store to prevent parked apps from being
