---
title: Display browsable search results  |  Android for Cars  |  Android Developers
...
# Display browsable search results Stay organized with collections Save and categorize content based on your preferences.
...
![Playback view with a **Search results** option to view media items
related to the user's voice search](/static/images/training/cars/search_results.png)
...
arrow\_forward](/training/cars/media/create-media-browser/custom-browse-actions)