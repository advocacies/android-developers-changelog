...
[car app category](/training/cars/apps/library/set-up-project#supported-app-categories) in the intent
...
**Important:** If your app supports both calling and [messaging](/training/cars/communication/templated-messaging), include both
