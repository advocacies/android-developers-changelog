---
title: Dim the system bars (deprecated)  |  Android Developers
...
# Dim the system bars (deprecated) Stay organized with collections Save and categorize content based on your preferences.





**Deprecated:** [setSystemUiVisibility](/reference/android/view/View#setSystemUiVisibility(int))
...
`SYSTEM_UI_FLAG_LOW_PROFILE` flag, as follows:
...
![system bars](/static/images/training/low_profile_hide2x.png)

**Figure 1.** Dimmed system bars.

Figure 2 shows the same gallery image, but with the system bars displayed:

![system bars](/static/images/training/low_profile_show2x.png)
...
`setSystemUiVisibility()`, you can do so
as follows:
