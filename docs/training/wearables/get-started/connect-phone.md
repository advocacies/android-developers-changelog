...
3. In the **Device Manager**, click the overflow menu icon next to a device you
   ...
   ![Tap the overflow menu icon next to a device you want to pair and select Pair Wearable](/static/training/wearables/images/emulator-pair-wearable.png)
...
![The Device Manager shows small icons next to the paired devices](/static/training/wearables/images/emulator-pair-button.png)
