---
title: Configure your phone app for Watch Face Push  |  Wear OS  |  Android Developers
...
# Configure your phone app for Watch Face Push Stay organized with collections Save and categorize content based on your preferences.
...
1. **Installation:** Install the watch face using Watch Face Push, initiated
...
2. **Activation:** [Set the installed watch face as active](/training/wearables/watch-face-push/wear-os-app#set-watch-face-as-active). This step has
   several possible paths, depending on the permission state:
