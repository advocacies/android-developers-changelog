---
title: Simulate sensor data with Health Services  |  Android health & fitness  |  Android Developers
...
**Caution:** This guide does not cover the
[extended emulator controls](/studio/run/emulator-extended-controls).
The extended emulator controls are not compatible with Health Services data
generation for Wear OS 4 or higher.
...
* Expanded support for exercise events: You can simulate receiving [auto pause
  and resume events](/reference/kotlin/androidx/health/services/client/data/ExerciseState#AUTO_PAUSED()),
  [fall events](/reference/kotlin/androidx/health/services/client/data/HealthEvent.Type#FALL_DETECTED()),
  [sleep detection](/reference/kotlin/androidx/health/services/client/data/UserActivityState#USER_ACTIVITY_ASLEEP()),
  and [golf shot detection](/reference/kotlin/androidx/health/services/client/data/GolfShotEvent).

**Note:** This method only works on the emulator and cannot be used for testing on
physical devices running Wear OS 4 or higher. To use these features, you must
[upgrade your emulator](/training/wearables/get-started/creating#configure-emulator)
to a version that supports Wear OS 4 or higher.

### Use the Health Services Sensor Panel

[Android Studio Koala Feature Drop (Canary)](/studio/preview) includes a
...
[golf shot swing type](/reference/kotlin/androidx/health/services/client/data/GolfShotEvent.GolfShotSwingType), which are outlined in the
following table:
...
1. Enable [developer options](/training/wearables/get-started/debugging#enable-dev-options).
...
* [SourceType](/training/wearables/wff/common/attributes/source-type)
* [ArithmeticExpression](/training/wearables/wff/common/attributes/arithmetic-expression)
