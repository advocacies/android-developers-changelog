---
title: DataStore  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.datastore](/reference/kotlin/androidx/datastore/package-summary)
...
| --- | --- | --- | --- | --- |
| May 06, 2026 | [1.2.1](/jetpack/androidx/releases/datastore#1.2.1) | - | - | [1.3.0-alpha09](/jetpack/androidx/releases/datastore#1.3.0-alpha09) |

## Declare dependencies

To add a dependency on DataStore, you must add the Google Maven repository to
your project. Read [Google's Maven repository](/studio/build/dependencies#google-maven)
for more information.

DataStore provides [different options for serialization](/topic/libraries/architecture/datastore#implementations)
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:907884%20status:open)
...
`androidx.datastore:datastore-*:1.2.1` is released. Version 1.2.1 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/9c556fd714d249b153cbe3ddce61e9eb43f77ffc..03aea68c431abd3fa436e9f8fa9b9cda12f18334).
