---
title: Wear Compose for Material 3  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.wear.compose.material3](/reference/kotlin/androidx/wear/compose/material3/package-summary)

Write Jetpack Compose applications for Wear OS devices by
providing functionality to support different device sizes and navigation
gestures using the Material 3 Expressive design system.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| August 27, 2025 | [1.5.0](/jetpack/androidx/releases/wear-compose#1.5.0) | - | - | - |

**Note:** This library supersedes the `androidx.wear.compose:compose-material`
library. This library implements Material 3 Expressive design for Wear OS and is
recommended for developers to use. Don't mix objects from this library with
objects in the [Compose Material 3](/jetpack/androidx/releases/compose-material3) mobile library.
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:1077552%20status:open)
...
* Support for non-round `ScrollIndicator` and `PageIndicator` has been removed from Material3. Square screen support is also no longer part of the Wear OS requirements, see the [Getting Started guide](/design/ui/wear/guides/foundations/getting-started) for more information. ([I9a852](https://android-review.googlesource.com/#/q/I9a852eb2312d4cd892f28836211db0aa79b3e9e4))
...
* Tokenize `RadioButton` and `SplitRadioButton` and also refactor the existing methods to reduce the amount of `CompositionLocal` lookup by adding cached instances of colors, and making methods of `RadioButtonColors` and `SplitRadioButtonColors` internal.
  ([I02b33](https://android-review.googlesource.com/#/q/I02b33fe3153a7fe596d5f83b0c6464b4eb9de282))
