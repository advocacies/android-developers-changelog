---
title: Car App  |  Jetpack  |  Android Developers
...
API Reference  
[androidx.car.app](/reference/kotlin/androidx/car/app/package-summary)  
[androidx.car.app.model](/reference/kotlin/androidx/car/app/model/package-summary)  
[androidx.car.app.navigation](/reference/kotlin/androidx/car/app/navigation/package-summary)  
[androidx.car.app.notification](/reference/kotlin/androidx/car/app/notification/package-summary)  
[androidx.car.app.serialization](/reference/kotlin/androidx/car/app/serialization/package-summary)  
[androidx.car.app.validation](/reference/kotlin/androidx/car/app/validation/package-summary)  
[androidx.car.app.versioning](/reference/kotlin/androidx/car/app/versioning/package-summary)

Build templated apps for Android Auto and Android Automotive OS.

| Latest Update | Stable Release | Release Candidate | Beta Release | Alpha Release |
| --- | --- | --- | --- | --- |
| September 09, 2026 | [1.7.0](/jetpack/androidx/releases/car-app#1.7.0) | [1.8.0-rc01](/jetpack/androidx/releases/car-app#1.8.0-rc01) | - | [1.9.0-alpha02](/jetpack/androidx/releases/car-app#1.9.0-alpha02) |

## Declaring dependencies

To add a dependency on the Car App Library, you must add the Google Maven
repository to your project. Read [Google's Maven repository](/studio/build/dependencies#google-maven)
...
[existing issues](https://issuetracker.google.com/issues?q=componentid:460472%20status:open)
...
`androidx.car.app:app-*:1.9.0-alpha02` is released. Version 1.9.0-alpha02 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/b5d2acb5ad0a36c9d2aba8feb4c7951165f30fbe..6ff76682a45583f1f17c9e3c945d4fb6704bb9f8/car/app).

**New Features**

* **App Theming**: Added `CarAppThemeSource` to allow apps to opt into brand theming and hosts to query preferred theme configurations.
* **Search Header**: Added `SearchHeader` for `SectionedItemTemplate` as a search header replacement in API 9.
* **Component Styling**: Added styling support for tabs (`TabStyle`), banners (`BannerStyle`), and media controls/progress indicators (`MediaPlaybackStyle`, `StrokeCap`).

**API Changes**

* **Media & Progress Bar Styling**: Added `MediaPlaybackStyle`, `setMediaAccentColor`, and standalone `StrokeCap` to customize playback controls and progress indicators. Updated `CarProgressBarStyle` to support nullable colors and removed deprecated color methods from `CarProgressBar`. ([Ib45c6](https://android-review.googlesource.com/#/q/Ib45c6ef9410ed4d5fbdf1c5c11136044c2f9da14), [I17141](https://android-review.googlesource.com/#/q/I17141d3ad7bfa9440b058ad7f2e7ea1fc0ff4500), [I270a4](https://android-review.googlesource.com/#/q/I270a412d7343ad8522785e12e3d2ed87ca4b2b6e), [I10fe4](https://android-review.googlesource.com/#/q/I10fe4e6025a18370a02359ed07bfab2c13c8abf4), [I80a17](https://android-review.googlesource.com/#/q/I80a17ddc39901e8ae2dfebe41bf57314f4141af5))
* **App Theming**: Introduced `CarAppThemeSource` for public app theme opt-in and added `onGetAppTheme` to `CarAppService` (with corresponding IPC) allowing hosts to query preferred theme configurations. ([I108f8](https://android-review.googlesource.com/#/q/I108f8b38061c2ac92e1f4ea40fe752f76fecde6c), [Ifbd41](https://android-review.googlesource.com/#/q/Ifbd41e57a39587500eef32ba8e05ca4110e0257b), [I97c7e](https://android-review.googlesource.com/#/q/I97c7e4b122460e7cff04ad4b3186c4e29b400d5c))
* **Tabs Styling**: Added support for custom background colors, content/text colors, and custom corner radii via `TabStyle`. ([I07330](https://android-review.googlesource.com/#/q/I0733028c8fea2f63d6fb123f61f418844d11b50f), [Id09f6](https://android-review.googlesource.com/#/q/Id09f637254401d9a620459c3284c0b272cb48b14))
* **Icons & Image Sizing**: Deprecated `IMAGE_TYPE_ICON` across `Row`, `GridItem`, `Banner`, and `CondensedItem` in favor of `IMAGE_TYPE_SMALL` and `IMAGE_TYPE_MEDIUM` size constants where icons render untinted by default. Reworked `CarIconStyle` and added custom shape support to `CarIcon`. ([Ie57fa](https://android-review.googlesource.com/#/q/Ie57fabbbd57132931e12221b6761730819a97d35), [I5cc2d](https://android-review.googlesource.com/#/q/I5cc2d90f6bf163eb89a15f3c41f8cc60430882c8), [Ic9584](https://android-review.googlesource.com/#/q/Ic95843091e63be651a365377030fc024a14475bc), [Iaef57](https://android-review.googlesource.com/#/q/Iaef57f39beeeccedfbe766611db01746516e343a))
* **Banners**: Added `BannerStyle` for custom shapes and corner radii, added image variant options (`IMAGE_TYPE_SMALL`, `IMAGE_TYPE_LARGE`), and removed deprecated icon and background APIs in favor of `setLeadingImage` and `addTrailingImage`. ([I265bb](https://android-review.googlesource.com/#/q/I265bb2ce14961ccb2436d47185e98c0ffb746a2a), [I7d28a](https://android-review.googlesource.com/#/q/I7d28af12725358e9f7df5eb5df5eee33f871c565), [I23f62](https://android-review.googlesource.com/#/q/I23f624b05d5edd780ebd9764ea904f2500d582d2), [I2917e](https://android-review.googlesource.com/#/q/I2917eda105168ebf1629340421d896499a8437f5), [I95b1c](https://android-review.googlesource.com/#/q/I95b1c4fe6ee01b522174daf15b8ffc8e64297636))
* **Headers & Layout**: Introduced `SearchHeader` for `SectionedItemTemplate` in API 9, added `startHeaderImage` to `Header` for custom start icons, and added `incompleteLastRowStrategy` to control handling of partial rows/columns in grid, condensed, and spotlight sections. ([I86632](https://android-review.googlesource.com/#/q/I8663211cad8f02050dcf5e818f929309fab72bbb), [I24937](https://android-review.googlesource.com/#/q/I249376c64a05fc714021221098664dfc5d161468), [If64be](https://android-review.googlesource.com/#/q/If64bedec227e4c3005c9982c305b3bb039247f23))

**Bug Fixes**

* Clarified that `Action.TYPE_MEDIA_PLAYBACK` is ignored as a template FAB on Car API 9+ hosts. ([Ie8fd4](https://android-review.googlesource.com/#/q/Ie8fd416677d2c86d59532b8c66db83f16ab674f4))
...
`androidx.car.app:app-*:1.8.0-beta01` is released. Version 1.8.0-beta01 contains [these commits](https://android.googlesource.com/platform/frameworks/support/+log/4d752a0684fb1bf991cd0d15ebd3649ee8684ca1..df4b49eda6f6834b6bc4c8aa30a581fa577a511e/car/app).

**New Features**

* Added support for Sectioned Item Template, allowing for more complex list and grid layouts.
* Enhanced Media Playback support.
* Added support for `IMAGE_TYPE_MEDIUM` in `RowImageType`.
* Added Intent Action `ACTION_MEDIA_SHOW_PLAYBACK_VIEW` to launch media playback screens.

**API Changes**

* Added support for `IMAGE_TYPE_MEDIUM` in `RowImageType` ([I76108](https://android-review.googlesource.com/#/q/I761087836bccbdcb309bd88606bc8aba323b3115))
* Add Intent Action `ACTION_MEDIA_SHOW_PLAYBACK_VIEW`. When this action is sent to an Activity that supports it, it indicates that the application should launch its playback screen, or a relevant screen otherwise ([If29db](https://android-review.googlesource.com/#/q/If29dbf6ef8fc5c59c7ab24e52b99c2d52c8a4e8b), [b/455949944](https://issuetracker.google.com/issues/455949944))

**Bug Fixes**

* Change default behavior of upcoming `SectionedItemTemplate` to save scroll state across template refreshes and back actions ([I6c9cc](https://android-review.googlesource.com/#/q/I6c9cc0a686e043604d9097a46747672b837c678c), [b/461256656](https://issuetracker.google.com/issues/461256656))
...
* Updated `PlaceListMapTempalte.Builder#setCurrentLocationEnabled` to
  indicate that ACCESS\_COARSE\_LOCATION would be sufficient for the feature ([I510c2](https://android-review.googlesource.com/#/q/I510c23f78aa740233dd9913e100835a6ae17b163))
...
* Fix an issue where the host validation logic was not finding the TEMPLATE\_RENDERER permission properly ([I62618](https://android-review.googlesource.com/#/q/I626184386c346a4017424a7eecbf91145f04fed3))
...
* Fix an issue where `CarNotificationManager.notify` would log an error for AutomotiveOS
  if there were actions with icons in the `CarAppExtender` ([I3633d](https://android-review.googlesource.com/#/q/I3633d343d2c9d706828a5fb747ddcc49914a0802))
...
* API Level 3: Added a `CarHardwareManager`that can be used to query vehicle’s hardware data, such as model and make, fuel levels and other sensors. Currently, this feature is only available for Android Auto 6.7+ in the open-testing channel. Testing this in a desktop environment requires a new version of `Desktop Head Unit` which will be released separately. Stay tuned on [Test Android apps for cars page](/training/cars/testing) for details on when the new version becomes available.
* Follow the [development guide](/training/cars/apps) and the library reference for additional details and design guidelines on how to use these features in car hosts that are compatible with API level 3.

**API Changes**

* Consolidated `SessionController` and `ScreenController` lifecycle methods into a single
  `moveToState` method ([I1ed00](https://android-review.googlesource.com/#/q/I1ed00d9e4df59af59643da25d9385f7a9326a3be))
...
* Updated `androidx.car.app.hardware` classes to remove
  unnecessary builders and parameter classes. ([I67beb](https://android-review.googlesource.com/#/q/I67bebfc9f418e125d28072171561375095aa518c))
* Added `androidx.car.app.hardware` classes for access to car
  specific data such as fuel, battery and speed. ([Iff3c9](https://android-review.googlesource.com/#/q/Iff3c92ebca831557ce2e475c5294e2701f6e5a2e))
...
* Added support for setting a toggle for an `Action`, and added
  the pan mode `Action` type ([Ica6af](https://android-review.googlesource.com/#/q/Ica6afbd94a10d2c6d007b6d45d76daeb3a22dfa7))
...
* Made `SignInTemplate` and `LongMessageTemplate` to require
  parked-only actions in their body and update documentation to indicate
  they will only be shown when the car is parked ([Iddaa9](https://android-review.googlesource.com/#/q/Iddaa95a90cba2731e2a52f89738fd9f906a381e5))
...
* Fixed an issue that require the app to explicitly take on a dependency on
  lifecycle-common-java8 ([I8b8c8](https://android-review.googlesource.com/#/q/I8b8c831d1fe033a2f8b8e653f373b10539dd0969))
...
This is the first Jetpack release of the previously closed source library, and is compatible with Android Auto 6.1 or above. Follow the [development guide](/training/cars/navigation) for details on how to build car apps using the library.

**New Features**

* Introduced a [`GridTemplate`](/reference/androidx/car/app/model/GridTemplate) which your app can use to show a list of UI elements in a grid layout.
* Introduced a [`CarAppService.createHostValidator`](/reference/androidx/car/app/CarAppService#createHostValidator()) method to validate that a host connection is from a trusted source (for example, Android Auto).
* Added a [`CarAppExtender.Builder.setColor`](/reference/androidx/car/app/notification/CarAppExtender.Builder#setColor(androidx.car.app.model.CarColor)) API. ([b/174231592](https://issuetracker.google.com/issues/174231592))
