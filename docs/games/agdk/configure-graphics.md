---
title: Configure graphics with OpenGL ES  |  Android game development  |  Android Developers
...
# Configure graphics with OpenGL ES Stay organized with collections Save and categorize content based on your preferences.
...
**Note:** The code in this topic is based on the
[Endless Tunnel](https://github.com/android/ndk-samples/tree/master/endless-tunnel)
sample, where details may differ for your game. Understand and adapt these
concepts for your specific use case.
