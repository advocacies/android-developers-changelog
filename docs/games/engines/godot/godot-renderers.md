---
title: Godot renderer options  |  Android game development  |  Android Developers
...
# Godot renderer options Stay organized with collections Save and categorize content based on your preferences.
...
* Lack of support for rendering features such as high-definition range,
  refraction properties, screen space reflections, or screen space ambient
  occlusion.
