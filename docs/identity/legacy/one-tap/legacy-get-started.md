---
title: Get started with One Tap sign-in and sign-up  |  Identity  |  Android Developers
...
# Get started with One Tap sign-in and sign-up Stay organized with collections Save and categorize content based on your preferences.
...
2. On the OAuth consent screen page, make sure all of the information is
   complete and accurate. In particular, make sure you have specified the URLs
   of your app's privacy policy and terms of service.
3. On the Credentials page, create an Android client ID for your app if you
...
1. In your project-level `build.gradle` file, make sure to include Google's
   Maven repository (`google()`) in both your `buildscript` and `allprojects`
   sections.
