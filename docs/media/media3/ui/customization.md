...
[`Player.Listener.onEvents()`](/reference/androidx/media3/common/Player.Listener#onEvents(androidx.media3.common.Player,%20androidx.media3.common.Player.Events)) for any change in selected tracks
