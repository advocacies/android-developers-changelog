---
title: Audio app overview  |  Legacy media APIs  |  Android Developers
...
# Audio app overview Stay organized with collections Save and categorize content based on your preferences.
