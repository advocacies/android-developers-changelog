---
title: Accessibility  |  Mobile  |  Android Developers
...
# Accessibility Stay organized with collections Save and categorize content based on your preferences.
...
![There are two blocks of text. The first
       ...
       at a ratio of 2.65:1.](/static/images/design/ui/mobile/accessibility-text-fail-color-contrast.png)
...
* [Describe UI elements](/guide/topics/ui/accessibility/apps#describe-ui-element) in your code. Compose uses [Semantics
  properties](/jetpack/compose/semantics#properties) to inform accessibility services about the information shown
  in UI elements.
...
![](/static/images/design/ui/mobile/accessibility-ui-elements-labeled.png)
...
* Ensure all touch targets are at least 48 dp, even if this extends past the UI
  element visual.
* Consider [haptic feedback](/develop/ui/views/haptics/haptics-principles) to help inform the user with additional,
...
![The UI on the left lets the user delete only by swiping,
  ...
  of a trash icon button.](/static/images/design/ui/mobile/accessibility-motor-skill.png)
