---
title: Widget configuration  |  Mobile  |  Android Developers
...
# Widget configuration Stay organized with collections Save and categorize content based on your preferences.
...
* If the widget appears empty without choosing settings or customization is
  central, directly open the configuration workflow during widget placement.
* If the widget has a preferred default or does not need the user to make a
  selection before viewing content, then your widget does not need an initial
  configuration screen. In these cases, let your user access configuration
  after placement.
...
![](/static/images/design/ui/mobile/widgets/widget-configuration-3.png)
...
![](/static/images/design/ui/mobile/widgets/widget-configuration-2.png)
...
![](/static/images/design/ui/mobile/widgets/widget-configuration-1.png)
...
![](/static/images/design/ui/mobile/widgets/widget-configuration-5.png)
...
![](/static/images/design/ui/mobile/widgets/widget-configuration-6.png)
...
![](/static/images/design/ui/mobile/widgets/Variation_do.png)
...
![](/static/images/design/ui/mobile/widgets/Variation_dont.png)
