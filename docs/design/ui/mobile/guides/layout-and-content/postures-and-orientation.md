---
title: Postures and orientation  |  Mobile  |  Android Developers
...
# Postures and orientation Stay organized with collections Save and categorize content based on your preferences.
...
![Navigation options for landscape.](/static/images/design/ui/mobile/layout_landscape_paw_nav.webp)

Landscape orientation can take advantage of the reduced height of a
horizontally oriented bottom navigation bar.

![full screen content on landscape](/static/images/design/ui/mobile/layout_landscape_content.webp)
...
![reflowing content on landscape](/static/images/design/ui/mobile/layout_content_hero.webp)

The hero image takes the prominent space and sticks. The bottom app bar
undocks.

![reflowing content on landscape](/static/images/design/ui/mobile/layout_portrait-landscape_rotate.webp)

From portrait to landscape: both container groupings rotate in place.

![Layout changes and component change](/static/images/design/ui/mobile/layout_landscape_filter.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/postures_all.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_fold_flat.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_folded.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_tabletop.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_fold_hinge.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_cover.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_cover_hero.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_cover_keyboard.webp)

The cover should remain highly focused on input. For example, when the keyboard
appears, the message is the primary focus.

![Layout changes and component change](/static/images/design/ui/mobile/layout_cover_filter.webp)

In smaller screens, like covers, the filter sheet is full-screen, but the
button placement and scaling adapt.

![Layout changes and component change](/static/images/design/ui/mobile/layout_cover_nav.webp)
...
![Layout changes and component change](/static/images/design/ui/mobile/layout_cover_sysUI.webp)

A small navigation rail can avoid system UI and camera cutouts while respecting
the condensed height.

![](/static/images/design/ui/mobile/layout_cover_e2e_do.webp)
...
![](/static/images/design/ui/mobile/layout_cover_e2e_dont.webp)
