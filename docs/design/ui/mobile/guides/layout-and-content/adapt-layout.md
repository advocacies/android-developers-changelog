---
title: Adapt layouts  |  Mobile  |  Android Developers
...
# Adapt layouts Stay organized with collections Save and categorize content based on your preferences.
...
* First, consider the device's window class width to determine layout changes,
  then adjust for height. [Support different screen sizes](/develop/ui/compose/layouts/adaptive/support-different-display-sizes).
...
sizes.](/static/images/design/ui/mobile/layout-basics-adapting-layouts.webp)

![](/static/images/design/ui/mobile/layout_anti_letterbox_dont.webp)
...
![Layout reflow](/static/images/design/ui/mobile/layout_reflowing.webp)
...
![](/static/images/design/ui/mobile/layout_adapt_maxwidth_do.png)
...
![](/static/images/design/ui/mobile/layout_adapt_maxwidth_dont.png)
...
![](/static/images/design/ui/mobile/layout_adapt_panes.png)
...
![](/static/images/design/ui/mobile/layout_sheet_do.webp)
...
![](/static/images/design/ui/mobile/layout_sheet_dont.webp)

cancel

### Don't

Stretch components, instead allow the component to change
presentation and set a max width.

![Stretched UI elements](/static/images/design/ui/mobile/layout_anti_stretched_dont.webp)
...
![List detail panes](/static/images/design/ui/mobile/layout_fold_panes.webp)
...
![Layout with responsive behavior](/static/images/design/ui/mobile/layout_pane-shift.webp)
...
![Scale ui with screen sizes and distance](/static/images/design/ui/mobile/layout_scaling_dont.webp)

Consider the scale and amount of content shown.

![small grid of videos on a phone becomes tight and overwhelming on a tablet](/static/images/design/ui/mobile/layout_grid_dont.webp)
...
A high quality app should meet the differentiated tier in [core app](/docs/quality-guidelines/core-app-quality) and
[large screen quality](/docs/quality-guidelines/large-screen-app-quality) guidelines.
...
![Landscape layout](/static/images/design/ui/mobile/layout_landscape_rotate.webp)

For control based layouts, like media players, allow the controls to reflow and
content to reveal.

![Cover screen layout](/static/images/design/ui/mobile/layout_cover_media.webp)
...
changes using the [`mediaQuery`](/develop/adaptive-apps/guides/mediaquery) API, which lets you add nuance when you
...
guides](/design/ui/desktop/guides/interaction/pointer-interactions).

![Keyboard input](/static/images/design/ui/mobile/layout_input.webp)

Check out a sample case study, [Pawparrazzi](/design/ui/gallery/social/pawparazzi), built and designed with the
latest adaptive apis and design guidance.

![Pawparazzi case study](/static/images/design/ui/mobile/gallery_paw_overview.webp)