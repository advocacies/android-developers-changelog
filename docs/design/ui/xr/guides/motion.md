---
title: Motion  |  XR Headsets & wired XR Glasses  |  Android Developers
...
# Motion Stay organized with collections Save and categorize content based on your preferences.
...
* **UI motion**: For user interface elements, you can follow established UI
  motion design standards, such as [Material Design's motion guidelines](https://m3.material.io/styles/motion/overview).
