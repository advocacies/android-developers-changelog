---
title: Overview  |  Wear  |  Android Developers
...
[
](/static/wear/images/design/adaptivedesign-hero.mp4)
...
![alt text](/static/wear/images/design/adaptivedesign-scrollinglayout.png)
...
![alt text](/static/wear/images/design/adaptivedesign-nonscrollinglayout.png)
...
![alt text](/static/wear/images/design/adaptivedesign-smallfirst.png)
...
![alt text](/static/wear/images/design/adaptivedesign-designforscale.png)
...
![alt text](/static/wear/images/design/adaptivedesign-fontsizes.png)
...
![alt text](/static/wear/images/design/adaptivedesign-allsizesready.png)
...
![alt text](/static/wear/images/design/adaptivedesign-responsive-optimized.png)
...
![alt text](/static/wear/images/design/adaptivedesign-adaptivedifferentiated.png)
...
**Caution:** A display size should *never* display less information than ones that
are smaller than it, this is especially relevant for custom behaviors added in
at the breakpoint. A common example of this is when components or text sizes are
increased past the breakpoint and end up showing less are the larger screens.
Screens should always show more value and never less value with increasing size.