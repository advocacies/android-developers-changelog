---
title: Principles for adding value  |  Wear  |  Android Developers
url: https://developer.android.com/design/ui/wear/guides/foundations/adaptive-design/principles-adding-value
source: html-scrape
---
...
# Principles for adding value Stay organized with collections Save and categorize content based on your preferences.
...
![alt text](/static/wear/images/design/addingvalue-morecontent.png)
...
![alt text](/static/wear/images/design/addingvalue-visibleelements-updated.png)
...
![alt text](/static/wear/images/design/addingvalue-improvedglanceability.png)
...
![alt text](/static/wear/images/design/addingvalue-improvedusability.png)

## Optimized compositions

Utilize our updated components and templates to offer a better look and feel for our UIs across all screen sizes.

![alt text](/static/wear/images/design/addingvalue-optimizedcompositions.png)
...
![alt text](/static/wear/images/design/addingvalue-nonscrollingtiles.png)

**Tiles (non-scrolling layouts)**

![alt text](/static/wear/images/design/addingvalue-scrollingapp.png)

**App scrolling layouts**

![alt text](/static/wear/images/design/addingvalue-appnonscrolling.png)
