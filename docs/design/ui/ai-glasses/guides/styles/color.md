...
judiciously to harmonize with the real world, to indicate important actions,
display imagery or provide semantic meaning.

Black is transparent on optical-see-through display. Keep this in mind when
designing as darker color will appear dull or transparent, but this can also be
...
When customizing colors for glasses, minimal visual obstruction and
harmonization with the real world is crucial, prioritize legibility across
varying lighting conditions. Carefully calibrate colors to balance brightness
against saturation to be instantly discernible.
...
**Note:** Try out the [Jetpack Compose Glimmer Skill](https://github.com/android/skills/blob/main/xr/display-ai-glasses-with-jetpack-compose-glimmer/SKILL.md) for help with contrast
calculation metrics.
...
* Ensure at least a 66% tone difference between foreground and background
...
Some colors use more power and generate more heat than others. Green is the
least power hungry, blue is the most, when comparing colors of equal tone as
seen on the right. Minimize the number of pixels you light up. The brighter the
screen, the hotter the display gets. Don't fill the screen with all white, as
...
* Surfaces should be no lighter than 34% tone in their focused state to
  maintain legibility for foreground elements.
...
![](/static/images/design/ui/glasses/guides/glasses_styles_color_surfacecontrast_do.png)

check\_circle

### Do

Provide contrast between surface and text. Approximate 66 tone difference is suggested to check for.

![](/static/images/design/ui/glasses/guides/glasses_styles_color_surfacecontrast_dont.png)

cancel

### Don't

Allow surface and text contrast to be too close.

![](/static/images/design/ui/glasses/guides/glasses_styles_color_surfacevariant_do.png)

check\_circle

### Do

Make sure Surface and Surface Variants have enough tone difference to create the necessary visual hierarchy.

![](/static/images/design/ui/glasses/guides/glasses_styles_color_surfacevariant_dont.png)
...
![](/static/images/design/ui/glasses/guides/glasses_styles_color_states_do.png)

check\_circle

### Do

Make sure there is enough contrast across all interaction states.

![](/static/images/design/ui/glasses/guides/glasses_styles_color_states_dont.png)
