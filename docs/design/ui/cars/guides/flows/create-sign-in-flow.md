---
title: Create a sign-in flow  |  Cars  |  Android Developers
...
# Create a sign-in flow Stay organized with collections Save and categorize content based on your preferences.
...
**Tip:** The sign-in flow works seamlessly in both Google built-in and Android Auto
if it is developed as described.
...
1. **Choose a primary sign-in method** and any backup methods from the
   available [sign-in methods](/design/ui/cars/guides/templates/sign-in-template#methods).
2. **Plan the task flow**, designing a sequence of templates to lead users
   through the sign-in task. For example: [sign in to the app while parked](/design/ui/cars/guides/flows/sign-in-while-parked).
3. **Validate usability**, ensuring that your planned flow meets the
   [UX requirements](/design/ui/cars/guides/ux-requirements/overview) for the Android for Cars App Library.

To learn more about designing with the templates, see
[Templates overview](/design/ui/cars/guides/templates/overview).

## Sign-in examples

![Example login page](/static/images/design/ui/cars/flows/sign-in-fig-1.png)


This example provides two different ways that the user can verify
their identity (Android Auto).


![Example Google login](/static/images/design/ui/cars/flows/sign-in-fig-2.png)


This example features Google sign-in, or two other
options (AAOS).


![Example login page](/static/images/design/ui/cars/flows/sign-in-fig-3.png)


This example features Google sign-in, or two other options
(AAOS).
